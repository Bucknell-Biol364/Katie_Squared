...
Katie Edwards and Katie Bille + Burley
...
We will be using existing data from Burley 1986. 
...
Data is from Burley 1986 paper. However, some information (like the age of the source populations, individual cohort information) was not available, which brings into question our ability to accurately reproduce the analyses.
...
Re-analysis of data from an experiment..
